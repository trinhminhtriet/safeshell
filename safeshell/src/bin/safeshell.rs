...
use safeshell::{config::Config, dialog, engine, init, Emojis, ShellContext};
            ...
            Ok(engine) => {
                    ...
                    engine.find_history_commands_from_shell_list(&shells_context)
                {
                    ...
                    if sensitive_commands.is_empty() {
                        ...
                        eprintln!(
                            "{} safeshell found {} sensitive commands in your shell history. run \
                             `safeshell find` to see more information",
                            emojis.alarm,
