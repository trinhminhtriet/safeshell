...
const SENSITIVE_PATTERN_TEMPLATE: &str = r###"# External sensitive patterns file allows you you add a custom patterns to safeshell
...
impl Config {
    ...
    /// Returns the root safeshell config folder
