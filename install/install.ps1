...
$repo = "safeshell"
$BinDir = "$Home\.safeshell\bin"
$downloadedFilePath = "${BinDir}\safeshell.zip"
$exeName = "safeshell.exe"
$downloadedExe = "$BinDir\$packageName\${exeName}"

# Get latest safeshell version from github API
...
$packageName = "safeshell-${tag}-x86_64-windows"
...
Write-Output "download safeshell binary: ${ResourceUri}"
...
# Download safeshell zip file from GitHub releases
